      ...
      {loading ? (
        ...
        <div className="container py-3">
          <div className="row">
            <span>
              <h6>
                {recordDetail !== undefined && Object.keys(recordDetail).length > 0 ? "Edit Activity" : "Activity"}
              </h6>
            </span>
          </div>
          <form
          ...
          >
            ...
            {module === "Accounts" || module === "Leads" ? (
              <input type="hidden" name="parent_id" value={crmid} />
            ) : (
              <input type="hidden" name="contact_id" value={crmid} />
            )}
